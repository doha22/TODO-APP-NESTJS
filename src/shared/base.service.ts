...
export abstract class BaseService<T extends Typegoose> {
    ...
    async map<T, K>(
        ...
        return this._mapper.map<T, K>(object as T,  destination);
    }
    ...
    async mapArray<T, K>(
        ...
        return this._mapper.mapArray<T, K>(object as T[],  destination)
    }
    ...
    //     return this._model.findByIdAndUpdate({_id:id} , item).exec();
    // }
